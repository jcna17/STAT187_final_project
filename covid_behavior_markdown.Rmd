...
data_recode_predict_no_state <- data_recode_predict %>%
  select(-state)

#add prediction column
data_recode_predict$pred <- predict(test_results_model, data_recode_predict_no_state)
...
predict_map_data <- data_recode_predict %>%
